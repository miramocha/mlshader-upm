...
Stable UPM release. Use Git tag **`v1.0.0`** to pin this version in `Packages/manifest.json` (see README).

### Changed

- Bump `package.json` version to **1.0.0** (first semver-stable baseline after the 0.1.0 layout and dependency alignment).
